...
<template>
  <div class="prose-article blog-content max-w-3xl mx-auto px-4 py-8">
    ...
    <section class="mb-8">
      <p class="mb-4">
        Το σωστό παπούτσι αλλάζει την εμπειρία της προπόνησης. Δείτε τι να
        διαλέξετε ανάλογα με το τι κάνετε εκείνη τη μέρα.
      </p>
      ...
      <p class="mb-4">
        Ελαφριά, responsive παπούτσια με λιγότερο αφρώδη πάτο — γρήγορη
        επαναφορά στο πάτημα, ευελιξία. Ιδανικά για διαλειμματική προπόνηση,
        επαναλήψεις και αγώνες έως 10χλμ.
      </p>
      ...
      <p class="mb-4">
        Για μεγάλες αποστάσεις προτιμήστε μέγιστη απορρόφηση κραδασμών και
        σταθερό cushioning που κρατάει την άνεση σε πολλά χιλιόμετρα —
        προτεραιότητα στην αντοχή, όχι στην ταχύτητα. Συνήθως έχουν μεγάλο
        αφρώδη πάτο αλλά ελαφριά αίσθηση.
      </p>
      ...
      <ul class="list-disc pl-5 mb-4">
        ...
        <li class="mb-2">
          Αλλάξτε παπούτσια όταν το cushioning φθίνει ή όταν αρχίζει να πονάει
          κάτι.
        </li>
        <li class="mb-2">
          Δοκιμάστε στο κατάστημα με τον δικό σας ρυθμό, ή σε μια παλιά κούρσα,
          πριν αποφασίσετε.
        </li>
      </ul>

      <p class="mb-4">
        Με λίγα λόγια: ελαφριά και responsive για speed, πολύ μαξιλαρωμένα για
        long runs, ανθεκτικά για καθημερινή χρήση. Τα carbon-plated είναι
        εργαλείο απόδοσης, όχι κάτι που φοράτε κάθε μέρα.
      </p>
    </section>
