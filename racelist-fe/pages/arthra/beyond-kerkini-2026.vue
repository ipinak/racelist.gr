  ...
  <div class="blog-content max-w-5xl mx-auto px-4 py-8">
    ...
    <div class="prose prose-lg max-w-none">
      <div class="bg-blue-50 p-6 rounded-lg mb-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <p class="mb-2"><strong>Τοποθεσία:</strong> Λίμνη Κερκίνη</p>
          </div>
          <div>
            <p class="mb-2"><strong>Διοργάνωση:</strong> SMF Sports</p>
            <p class="mb-2"><strong>Τύπος:</strong> Trail / Road Running</p>
          </div>
        </div>
      </div>
      ...
      <p class="text-lg mb-6">
        Το Beyond Kerkini 2026 πραγματοποιήθηκε με μεγάλη επιτυχία στην περιοχή
        ...
        <table class="min-w-full bg-white border border-gray-300">
          ...
          <tbody class="divide-y divide-gray-200">
            ...
            <tr class="hover:bg-gray-50">
              ...
              <td class="py-3 px-4">1:29:14</td>
              <td class="py-3 px-4">14.12</td>
            </tr>
          </tbody>
        </table>
      </div>
        ...
        <table class="min-w-full bg-white border border-gray-300">
          ...
          <tbody class="divide-y divide-gray-200">
            ...
            <tr class="hover:bg-gray-50">
              ...
              <td class="py-3 px-4">
                Μαραθωνοδρόμοι Σερρών / ΑΣΣ ΑΛΕΞΑΝΔΡΟΣ ΜΑΚΕΔΟΝΙΑΣ
              </td>
              <td class="py-3 px-4">1:08:47</td>
              <td class="py-3 px-4">13.08</td>
            </tr>
          </tbody>
        </table>
      </div>
        ...
        <table class="min-w-full bg-white border border-gray-300">
          ...
          <tbody class="divide-y divide-gray-200">
            ...
            <tr class="hover:bg-gray-50">
              ...
              <td class="py-3 px-4">0:56:17</td>
              <td class="py-3 px-4">13.86</td>
            </tr>
          </tbody>
        </table>
      </div>
        ...
        <table class="min-w-full bg-white border border-gray-300">
          ...
          <tbody class="divide-y divide-gray-200">
            ...
            <tr class="hover:bg-gray-50">
              ...
              <td class="py-3 px-4">0:22:22</td>
              <td class="py-3 px-4">16.10</td>
            </tr>
          </tbody>
        </table>
      </div>
      ...
      <p class="text-lg mb-4">
        Το Beyond Kerkini είναι ένας αγώνας ορεινού τρεξίματος που διεξάγεται
        στην περιοχή της Λίμνης Κερκίνης στις Σέρρες. Οι αθλητές έχουν την
        ευκαιρία να τρέξουν σε μια από τις πιο όμορφες φυσικές τοποθεσίες της
        Βόρειας Ελλάδας, με διαδρομές που περιλαμβάνουν ποικιλία εδάφους και
    ...
    meta: [
      {
        name: 'description',
        content:
          'Αποτελέσματα από τον αγώνα Beyond Kerkini 2026 στη Λίμνη Κερκίνης. Δείτε τα αποτελέσματα για τις αποστάσεις 21χλμ., 15χλμ., 13χλμ., 10χλμ. και 6χλμ.',
      },
      {
        property: 'og:title',
