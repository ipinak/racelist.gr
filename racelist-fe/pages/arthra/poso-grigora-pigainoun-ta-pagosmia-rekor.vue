    ...
    <div class="prose prose-lg max-w-none">
      <div class="bg-paper-dim border-l-4 border-blue p-6 rounded-lg mb-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            <p class="mb-2"><strong>Θέμα:</strong> Ταχύτητα παγκόσμιων ρεκόρ σε 5χλμ, 10χλμ, ημιμαραθώνιο, μαραθώνιο</p>
            <p class="mb-2"><strong>Αφορμή:</strong> Το ρεκόρ του Jakob Ingebrigtsen στα 5χλμ δρόμου</p>
          </div>
          <div>
            <p class="mb-2"><strong>Μονάδα μέτρησης:</strong> Μέση ταχύτητα σε χλμ/ώρα</p>
            <p class="mb-2"><strong>Ενημέρωση:</strong> Αύγουστος 2026</p>
          </div>
        </div>
      </div>

      <p class="text-lg mb-6">
        Όταν βλέπουμε έναν χρόνο σαν <strong>2:00:35</strong> σε μαραθώνιο ή
        <strong>13:15.29</strong> σε 5χλμ δρόμου, είναι δύσκολο να
        καταλάβουμε πραγματικά πόσο γρήγορο είναι. Ο πιο εύκολος τρόπος να το
        «νιώσουμε» είναι να μετατρέψουμε τον χρόνο σε μέση ταχύτητα — πόσα
        χιλιόμετρα την ώρα τρέχει ένας κορυφαίος αθλητής, από την πρώτη μέχρι
        την τελευταία στιγμή του αγώνα. Ας δούμε πώς συγκρίνονται τα σημερινά
        παγκόσμια ρεκόρ στις πιο δημοφιλείς αποστάσεις του δρόμου.
      </p>
      ...
      <p class="text-lg mb-4">
        Ο Νορβηγός <strong>Jakob Ingebrigtsen</strong>, ένας από τους καλύτερους, γρηγορότερους και πιο ολοκληρωμενους 
        δρομεας της γενιάς του, έτρεξε
        τα <strong>5 χιλιόμετρα δρόμου</strong> σε
        <strong>13:15.29</strong>. Αυτό μεταφράζεται σε μέσο ρυθμό περίπου
        <strong>2:39 ανά χιλιόμετρο</strong>, δηλαδή μέση ταχύτητα γύρω στα
        <strong>22,6 χλμ/ώρα</strong> — για 13 ολόκληρα λεπτά, χωρίς παύση,
        χωρίς αλλαγή ρυθμού. Για σύγκριση, ένας καλά προπονημένος ερασιτέχνης
        δρομέας τρέχει συνήθως 10-12 χλμ/ώρα σε μια προπόνηση αντοχής — ο
        Ingebrigtsen πηγαίνει σχεδόν διπλάσια ταχύτητα, για μεγαλύτερη
        απόσταση.
      </p>
      ...
      <div class="bg-flag/10 border-l-4 border-flag p-6 rounded-lg mb-8">
        <p class="mb-0">
          ...
          ώρες είναι περίπου 0,2209 — άρα 5 ÷ 0,2209 ≈ 22,6 χλμ/ώρα.
        </p>
      </div>
      ...
      <p class="text-lg mb-4">
        Όσο μεγαλώνει η απόσταση, τόσο πέφτει η μέση ταχύτητα, είναι λογικό,
        αφού το σώμα δεν μπορεί να διατηρήσει την ίδια ένταση για ώρες όσο για
        λεπτά. Παρ' όλα αυτά, η πτώση είναι εντυπωσιακά μικρή στην κορυφή του
        αθλήματος.
      </p>
        ...
        <table class="min-w-full bg-paper border border-line">
          <thead class="bg-blue-deep text-white">
            <tr>
              ...
              <th class="py-3 px-4 text-left">Μέσος Ρυθμός</th>
          ...
          <tbody class="divide-y divide-line">
            ...
            <tr class="hover:bg-paper-dim">
              ...
              <td class="py-3 px-4">2:52/χλμ</td>
              <td class="py-3 px-4">~21,0 χλμ/ώρα</td>
            </tr>
          </tbody>
        </table>
      </div>
      ...
      <p class="text-lg mb-4">
        Παρατηρήστε κάτι εντυπωσιακό: από τα 5χλμ μέχρι τον ημιμαραθώνιο, η
        μέση ταχύτητα των κορυφαίων αθλητών πέφτει ελάχιστα — γύρω στο
        1-2%. Η πραγματική «κατάρρευση» ταχύτητας έρχεται στον μαραθώνιο, όπου
        η απόσταση είναι διπλάσια του ημιμαραθωνίου και το σώμα πρέπει να
        διαχειριστεί ενεργειακά αποθέματα, θερμορύθμιση και μυϊκή κόπωση για
        πάνω από δύο ώρες.
      </p>
        ...
        <table class="min-w-full bg-paper border border-line">
          ...
          <tbody class="divide-y divide-line">
            ...
            <tr class="hover:bg-paper-dim">
              ...
              <td class="py-3 px-4">~19,5 χλμ/ώρα</td>
            </tr>
          </tbody>
        </table>
      </div>
        ...
        <ul class="space-y-3">
          <li class="flex items-start gap-2">
            ...
            <span>
              ...
              Στον μαραθώνιο, ο οργανισμός πρέπει να «οικονομήσει» ενέργεια
              για ώρες, γι' αυτό ο ρυθμός είναι πιο συντηρητικός.
            </span>
          </li>
          <li class="flex items-start gap-2">
            <span class="text-blue font-bold text-lg">🔥</span>
            <span>
              ...
              διαχείριση ενεργειακών γελ και υδατανθράκων γίνεται καθοριστικός
          ...
          <li class="flex items-start gap-2">
            ...
            <span>
              ...
              αναγκάζει τον αθλητή να μειώσει ελαφρώς την ένταση.
            </span>
          </li>
          <li class="flex items-start gap-2">
            <span class="text-blue font-bold text-lg">🦵</span>
            <span>
              ...
              μυϊκής απόδοσης — το γνωστό «τείχος» των μαραθωνοδρόμων γύρω
              στο 30-35ό χιλιόμετρο.
            </span>
          </li>
        </ul>
      </div>
      ...
      <p class="text-lg mb-4">
        Το εντυπωσιακό δεν είναι μόνο πόσο γρήγορα τρέχουν οι σημερινοί
        πρωταθλητές, αλλά και πόσο γρήγορα «σπάνε» τα ρεκόρ τα τελευταία
        χρόνια. Ο μαραθώνιος είναι χαρακτηριστικό παράδειγμα: από τα 2:03:23
        του Wilson Kipsang το 2013, φτάσαμε στο 2:00:35 του Kelvin Kiptum το
        2023 — μια βελτίωση σχεδόν <strong>3 λεπτών</strong> μέσα σε μία
        δεκαετία, χάρη σε συνδυασμό καλύτερης προπόνησης, διατροφής,
        τεχνολογίας υποδημάτων (καρβοφόρα πέλματα) και πιο επιστημονικής
        οργάνωσης αγώνων-ρεκόρ.
      </p>

      <p class="text-lg mb-4">
        Στα 5χλμ δρόμου, η πρόοδος είναι εξίσου εντυπωσιακή: μέσα σε λίγα
        χρόνια οι κορυφαίοι χρόνοι έπεσαν κατά δεκάδες δευτερόλεπτα, καθώς
        ολοένα και περισσότεροι αθλητές του στίβου (1.500μ, 5.000μ) στρέφονται
        σε αγώνες δρόμου εκτός σταδίου, φέρνοντας μαζί τους ταχύτητα και
        τεχνική πρωτόγνωρη για την απόσταση.
      </p>
      ...
      <p class="text-lg mb-4">
        Δεν χρειάζεται να τρέχετε 22 χλμ/ώρα για να απολαύσετε το τρέξιμο,
        αυτοί οι χρόνοι είναι το απόλυτο όριο της ανθρώπινης αντοχής. Αλλά η
        λογική πίσω από την πτώση ταχύτητας με την απόσταση ισχύει εξίσου και
        για εσάς: αν τρέχετε 5χλμ σε ρυθμό Χ, ο ρεαλιστικός στόχος για
        μαραθώνιο είναι συνήθως 15-20% πιο αργός ρυθμός, όχι ο ίδιος.
      </p>
      ...
      <p class="text-lg mb-4">
        ...
        μπορούσατε ρεαλιστικά να πετύχετε σε 10χλμ, ημιμαραθώνιο ή μαραθώνιο,
...
<script setup>
  useHead({
    title: 'Πόσο Γρήγορα Πάνε τα Παγκόσμια Ρεκόρ; | racelist.gr',
    link: [
      {
        rel: 'canonical',
        href: 'https://racelist.gr/arthra/posi-grigora-pigainoun-ta-pagosmia-rekor/',
      },
    ],
    meta: [
      {
        name: 'description',
        content:
          'Πόσο γρήγορα τρέχουν οι κορυφαίοι δρομείς του κόσμου; Ανάλυση ταχύτητας των παγκόσμιων ρεκόρ σε 5χλμ, 10χλμ, ημιμαραθώνιο και μαραθώνιο, με αφορμή το ρεκόρ του Jakob Ingebrigtsen στα 5χλμ.',
      },
      {
        name: 'keywords',
        content:
          'παγκοσμιο ρεκορ, ταχυτητα τρεξιματος, ingebrigtsen, 5km, 10km, ημιμαραθωνιος, μαραθωνιος, χλμ ανα ωρα, ρυθμος τρεξιματος',
      },
      {
        name: 'author',
        content: 'racelist.gr',
