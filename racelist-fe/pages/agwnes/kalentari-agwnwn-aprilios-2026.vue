    ...
    meta: [
      {
        name: 'description',
        content:
          'Δες όλους τους αγώνες τρεξίματος δρόμου και βουνού για τον Απρίλιο 2026 σε κάθε γωνιά της Ελλάδας. Ημερομηνίες, αποστάσεις και πληροφορίες για κάθε αγώνα του μήνα.',
      },
      // Open Graph
      {
        property: 'og:title',
    ...
    script: [
      {
        ...
        "description": "Δες όλους τους αγώνες τρεξίματος δρόμου και βουνού για τον Απρίλιο 2026 σε κάθε γωνιά της Ελλάδας. Ημερομηνίες, αποστάσεις και πληροφορίες για κάθε αγώνα του μήνα."
      }`,
      },
    ],
  });
