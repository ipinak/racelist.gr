...
<script setup>
  ...
  const races = computed(() => {
    ...
    return allRaces.value.filter((race) => {
      ...
      return raceDate.getMonth() === 11 && raceDate.getFullYear() === 2025;
    });
  });
  ...
  useHead({
    ...
    link: [
      {
        rel: 'canonical',
        href: 'https://racelist.gr/agwnes/kalentari-agwnwn-dekembrios-2025/',
      },
    ],
    meta: [
      {
        name: 'description',
        content:
          'Δες όλους τους αγώνες τρεξίματος δρόμου και βουνού για τον Δεκέμβριο 2025 σε κάθε γωνιά της Ελλάδας. Ημερομηνίες, αποστάσεις και πληροφορίες για κάθε αγώνα του μήνα.',
      },
      // Open Graph
      {
        property: 'og:title',
    ...
    script: [
      {
        ...
        "description": "Δες όλους τους αγώνες τρεξίματος δρόμου και βουνού για τον Δεκέμβριο 2025 σε κάθε γωνιά της Ελλάδας. Ημερομηνίες, αποστάσεις και πληροφορίες για κάθε αγώνα του μήνα."
      }`,
      },
    ],
  });
