<template>
  <div class="max-w-4xl mx-auto px-4 py-8">
    ...
    <h2 class="font-display text-2xl text-center text-ink my-6">
...
<script setup>
  ...
  const races = computed(() => {
    ...
    return allRaces.value.filter((race) => {
      ...
      return raceDate.getMonth() === 3 && raceDate.getFullYear() === 2025; // April is month 3 (0-based)
    });
  });
    ...
    meta: [
      {
        name: 'description',
        content:
          'Δες όλους τους αγώνες τρεξίματος δρόμου και βουνού για τον Απρίλιο 2025 σε κάθε γωνιά της Ελλάδας. Ημερομηνίες, αποστάσεις και πληροφορίες για κάθε αγώνα του μήνα.',
      },
      // Open Graph
      {
        property: 'og:title',
        content:
          'Καλένταρι αγώνων δρομου και βουνού για τον Απρίλιο | racelist.gr',
      },
      {
    ...
    script: [
      {
        ...
        "description": "Δες όλους τους αγώνες τρεξίματος δρόμου και βουνού για τον Απρίλιο 2025 σε κάθε γωνιά της Ελλάδας. Ημερομηνίες, αποστάσεις και πληροφορίες για κάθε αγώνα του μήνα."
      }`,
      },
    ],
  });
