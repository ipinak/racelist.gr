    ...
    meta: [
      {
        name: 'description',
        content:
          'Δες όλους τους αγώνες τρεξίματος δρόμου και βουνού για τον Ιούνιο 2025 σε κάθε γωνιά της Ελλάδας. Ημερομηνίες, αποστάσεις και πληροφορίες για κάθε αγώνα του μήνα.',
      },
      // Open Graph
      {
        property: 'og:title',
        content:
          'Καλένταρι αγώνων δρομου και βουνού για τον Ιούνιο | racelist.gr',
      },
      {
      ...
      {
        property: 'og:url',
        content: 'https://racelist.gr/agwnes/kalentari-agwnwn-iounios-2025/',
      },
    ...
    script: [
      {
        ...
        "description": "Δες όλους τους αγώνες τρεξίματος δρόμου και βουνού για τον Ιούνιο 2025 σε κάθε γωνιά της Ελλάδας. Ημερομηνίες, αποστάσεις και πληροφορίες για κάθε αγώνα του μήνα."
      }`,
      },
    ],
  });
