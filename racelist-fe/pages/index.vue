  ...
  <div>
    <div class="flex justify-center">
      <p class="sm:px-48 sm:py-10 md:px-24 p-2 text-center text-lg">
        Το <strong>racelist.gr</strong> είναι το μοναδικό σημείο με όλους τους αγώνες σε όλη την Ελλάδα! 
        Εδώ θα βρεις το πλήρες ημερολόγιο αγώνων δρόμου και trail running από κάθε γωνιά της χώρας μας. 
        Χρησιμοποίησε τα εργαλεία που θα σου κάνουν την προπόνηση πιο εύκολη και διάβασε άρθρα γεμάτα 
        έμπνευση και χρήσιμες συμβουλές για δρομείς κάθε επιπέδου.
      </p>
    </div>
