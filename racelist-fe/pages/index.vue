  ...
  <div>
    <div class="flex justify-center">
      <p class="sm:px-48 sm:py-10 md:px-24 p-2 text-center text-lg">
        Το
        <strong>racelist.gr</strong> συγκεντρώνει όλους τους αγώνες δρόμου της
        Ελλάδας σε ένα σημείο. Βρες τη διοργάνωση που σε ενδιαφέρει, διάβασε
        χρήσιμα άρθρα για προπόνηση και εξοπλισμό, και οργάνωσε το αγωνιστικό
        σου πρόγραμμα εύκολα.
      </p>
    </div>
